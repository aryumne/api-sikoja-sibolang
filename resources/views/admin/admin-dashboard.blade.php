                ...
                <div class="card-body p-3 position-relative">
                    <div class="row">
                        <div class="col-7 text-start">
                            ...
                            <span class="font-weight-normal text-secondary text-sm"><span class="font-weight-bolder text-success">+$213</span>
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="card h-100">
                ...
                <div class="card-footer pt-0 pb-0 p-3 d-flex align-items-center">
                    <div class="w-60">
                        <p class="text-sm">
                            More than <b>1,200,000</b> sales are made using referral
                            marketing, and <b>700,000</b> are from social media.
                        </p>
                    </div>
                                    ...
                                    <td>
                                        <div class="d-flex px-3 py-1">
                                            ...
                                            <div class="d-flex flex-column justify-content-center">
                                                ...
                                                <p class="text-sm font-weight-normal text-secondary mb-0"><span class="text-success">8.232</span>
                                                    orders</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex px-3 py-1">
                                            ...
                                            <div class="d-flex flex-column justify-content-center">
                                                ...
                                                <p class="text-sm font-weight-normal text-secondary mb-0"><span class="text-success">12.821</span>
                                                    orders</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex px-3 py-1">
                                            ...
                                            <div class="d-flex flex-column justify-content-center">
                                                ...
                                                <p class="text-sm font-weight-normal text-secondary mb-0"><span class="text-success">2.421</span>
                                                    orders</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex px-3 py-1">
                                            ...
                                            <div class="d-flex flex-column justify-content-center">
                                                ...
                                                <p class="text-sm font-weight-normal text-secondary mb-0"><span class="text-success">5.921</span>
                                                    orders</p>
                                            </div>
                                        </div>
                                    </td>
